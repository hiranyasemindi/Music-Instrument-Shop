...
class Process
{
    ...
    {
        return "assets/img/profile_images/" . $_SESSION["admin"]["name"] . "_" . uniqid() . $new_file_extention;
    }
    ...
    {
        return $this->iud("UPDATE `admin` SET `profile_img`='" . $file_name . "'  WHERE `email`='" . $email . "'");
    }
