        ...
        if ($_SESSION["admin"]) {
            ...
            if ($admin) {
                ...
                if (isset($_GET["id"])) {
                    ...
                    if ($models) {
                        SingleModels::generate($model);
                    }
                } else if (isset($_GET["name"])) {
                    SingleModels::generate();
                } else {
...
?>
        <!-- categorys -->
        <div class="row mt-4 orders" id="models_area">
            <div class="w-[43%] bg-white pt-5 ps-5 pe-5 pb-5 ml-[7%]">
                <span class="mb-[35px] text-2xl text-[#AD1212] fw-semibold">Models</span>
            </div>
            <div class="w-[43%] bg-white pt-5 ps-5 pe-5 pb-5  text-end" onclick="addMod();">
                <button class="bg-[#AD1212] text-white p-2 rounded "><i class="bi bi-plus-lg pe-2"></i>Add Model</button>
            </div>
                ...
                <div class="row">
                    <table class="table hover:cursor-pointer">
                        ...
                        <tbody class="">
                            ...
                            ?>
                                <tr class="border-[#AD1212]" onclick="singleModel(<?php echo $model['id']; ?>);">
...
?>
        ...
        <div class="row mt-4" style="overflow-y: scroll; height:44rem;" id="singleBrand_area">
            <div class="w-[86%] bg-white pt-5 ps-5 pe-5 pb-5 ml-[7%] ">
                <span class="mb-[35px] text-2xl text-[#AD1212] fw-semibold"><?php echo $model ? "Edit" : "Add"; ?> Model</span>
            </div>
            <div class="w-[86%] bg-white pt-2 ps-5 pb-4 pe-5 ml-[7%] ">
                <div class="flex  items-center p-4 d-none text-sm text-red-800 border border-red-300 rounded-lg bg-red-50" id="m_alertBox" role="alert">
                    ...
                    <div class="col-12 ">
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2">
                                <div class="row">
                                    <input type="text" value="<?php echo $model ? $model["model_name"] : ""; ?>" id="m_name" <?php echo $model ? "disabled" : ""; ?> class="p-3 outline-none border-[1px] border-[#AD1212]">
                                    <div class="mt-4 text-center">
                                        <?php
                                        if ($model) {
                                        ?>
                                            <button id="editMoBtn" onclick="editModel();" class="bg-[#AD1212] w-[40%] text-white p-[14px] rounded ">Edit Model</button>
                                            <button onclick="updateModel(<?php echo $model['id']; ?>);" id="updateMoBtn" class="bg-[#AD1212] w-[40%] text-white d-none p-[14px] rounded ">Update Model</button>

                                        <?php
                                        } else {
                                        ?>
                                            <button onclick="addModel();" class="bg-[#AD1212] w-[40%] text-white p-[14px] rounded ">Add Model</button>
