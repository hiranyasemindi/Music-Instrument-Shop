                        ...
                        <div class="row">
                            ...
                            <div class="col-10 offset-1 py-5 " id="signInBox">
                                <div class="row">
                                    ...
                                    <div class="col-12   ">
                                        <div class="row  ">
                                            <input type="password" class="border-y border-l w-[85%]  h-[40%]  py-3 ps-3 focus:outline-none mt-3" id="loginPassword" placeholder="Password" value="<?php echo $password; ?>">
                                            <div class="w-[15%] border-y border-r flex items-center justify-end  mt-3">
                                                <i class="bi bi-eye-slash-fill hover:cursor-pointer text-xl  text-[#A9A9AF] " id="icon-visibility" onclick="loginVisibility();"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <p class=" text-end pt-1 text-[#AD1212] mt-3 hover:cursor-pointer mt-lg-0" onclick="forgotPassowrd();">Forgot Password?</p>
                            ...
                            <!-- Main modal -->
                            <div id="fp-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 mt-[8%] ml-[35%] h-[calc(100%-1rem)] max-h-full">
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow ">
                                        ...
                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                                            ...
                                            <button type="button" class="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center " data-modal-hide="fp-modal">
                                        ...
                                        <div class="p-4 md:p-5">
                                            <form class="space-y-4" action="#">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" id="vcode" placeholder="****" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " required />
                                                </div>
                                                <div>
                                                    <label class="block mb-2 text-sm font-medium text-gray-900 ">New password</label>
                                                    <input type="password" oninput="validateNewPassword();" id="new_password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " required />
                                                </div>
                                                <div>
                                                    <label class="block mb-2 text-sm font-medium text-gray-900 ">Confirm password</label>
                                                    <input type="password" id="confirm_password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " required />
                                                </div>
                                                <button onclick="resetPassword();" type="submit" class="w-full mt-4 text-white bg-[#AD1212] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Confirm</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-10 offset-1 d-none py-5" id="signUpBox">
                                <div class="row">
                                    ...
                                    <div class="col-12   ">
                                        <div class="row  ">
                                            <input oninput="validatePassword();" type="password" class="border-y border-l w-[85%]  h-[40%]  py-3 ps-3 focus:outline-none mt-3" id="password" placeholder="Password">
                                            <div class="w-[15%] border-y border-r flex items-center justify-end  mt-3">
                                                <i class="bi bi-eye-slash-fill hover:cursor-pointer text-xl  text-[#A9A9AF] " id="icon-visibility2" onclick="registerVisibility();"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12   ">
